...
const DashboardLayout = () => {
 ...
 <div className="drawer lg:drawer-open">
  ...
  <div className="drawer-content">
     ...
     {/* Navbar */}
      <nav className="navbar w-full bg-red-600 text-white">
   ...
   <div className="drawer-side is-drawer-close:overflow-visible">
    ...
    <div className="flex min-h-full flex-col items-start text-red-800 bg-base-300 is-drawer-close:w-14 is-drawer-open:w-64">
